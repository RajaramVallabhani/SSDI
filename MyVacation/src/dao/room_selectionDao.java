...
public class room_selectionDao {
	...
	public static String[] Update(String checkin_date,String checkout_date) throws SQLException {          
        boolean status = false;  
        Connection conn = null;  
        PreparedStatement pst = null;  
		//Driver mysqlDriver=new com.mysql.jdbc.Driver();
	...
	public static String[] Insert(String roomtype,String hotelname, String dest) throws SQLException {          
        boolean status = false;  
        Connection conn = null;  
        PreparedStatement pst = null;  
		//Driver mysqlDriver=new com.mysql.jdbc.Driver();
